    ...
    <div>
      <div
        className={classNames(
          ...
          {
            'border-l border-gray-300': hasBorder,
            'px-5 text-white': theme === 'normal',
            'py-2 px-2 bg-white text-primary rounded-sm': theme === 'bold',
          }
        )}
      >
...
const Header = (props) => {
  return (
    <header className="p-3 bg-primary dark:bg-primary-dark text-white text-lg font-heading mb-5 border-b">
      <nav className="flex justify-between items-center space-x-2 w-full text-md">
        <div className="w-10 mr-2">
          <Link href="/">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="block max-w-full fill-current transition duration-500 ease-in-out transform hover:rotate-45"
              viewBox="0 0 50 50"
            >
        ...
        <div className="flex justify-center items-center space-x-2 ml-10">
          <NavigationItem href="/" title="Home" hasBorder={false} />
          <NavigationItem href="/tools/strip-tags" title="Strip Tags" />
          <NavigationItem href="/tools/colour-manager" title="Colour Manager" />
          <NavigationItem
            href="/tools/password-generator"
            title="Password Generator"
          />
          <NavigationItem href="/tools/text-formatter" title="Text Formatter" />
          <NavigationItem
            href="/tools/pixel-converter"
